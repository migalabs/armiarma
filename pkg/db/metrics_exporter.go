...
func ServeMetrics() {
	...
	// TODO: Refactor with @tdahar prometheus exporter method
...
func initPeerPrometheusMetrics() {
	// register variables
...
func initClientDistributionSQL() {
	// register variables

}

func runClientDistributionSQL() {
