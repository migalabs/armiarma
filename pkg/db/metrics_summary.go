...
func (c *Client) AddVersion(inputVersion string) {
	...
	// new version, otherwise we would have returned
	newVersion := Version{
		Name:  inputVersion,
		Count: 1,
	}
...
// @param clientVersion: the version to add or create in the given client.
...
// GetClientNames:
// This method returns the names of the watched clients.
...
// Constructor for StringMapMetric.
